...
### States should:
- Repeal any state-level restrictions on novel foodtech

## Eliminate farm subsidies and price supports
### Congress should:
- Eliminate farm income supports (ARC, PLC) and subsidized FCIP crop insurance in the next Farm Bill and put savings into Ag R&D (FFAR, AgARDA, NIFA)
...
- Cut or eliminate agricultural protectionism (high MFN rates on certain commodities, AD/CVD, regulatory protectionism like FSIS continuous inspection of catfish)
...
## Misc food affordability reforms
### Congress should:
...
- Legalize and encourage via grants greater automation in public safety: red light cameras, ShotSpotter, drones for chases, ALPR, POD cameras, predictive policing software like PredPol
...
- Tort reform
    ...
    - Amend Rule 26 of Federal Rules of Civil Procedure to require disclosure of Third Party Litigation Financing (TPLF) agreements
    - Implement McHaffie Rule in states that don't already have it
    - Require unanimous jury verdicts for punitive damages
...
## Elections
### Congress should:
- Amend _Uniform Congressional District Act_ to allow multimember districts (max district magnitude of 5?) with a proportionality requirement ([ideally open-list PR](https://protectdemocracy.org/work/toward-a-different-kind-of-party-government/))
